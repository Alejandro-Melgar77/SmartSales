    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Administrador'), ('seller', 'Vendedor'), ('customer', 'Cliente'), ('manager', 'Gerente')], default='customer', max_length=20)),
                ('phone', models.CharField(blank=True, max_length=20)),
                ('address', models.TextField(blank=True)),
                ('ciudad', models.CharField(blank=True, max_length=100)),
                ('pais', models.CharField(blank=True, default='Bolivia', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('permisos', models.ManyToManyField(blank=True, to='users.permiso')),
            ],
            options={
                'verbose_name': 'Rol',
        ...
        migrations.AddIndex(
            model_name='user',
            index=models.Index(fields=['ciudad'], name='users_user_ciudad_ce9b5b_idx'),
        ),
    ]
